...
return (
  ...
  <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 sm:px-6 text-black">
    ...
    <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-6 sm:p-8 space-y-6">
      ...
      <form onSubmit={submit} className="space-y-4 sm:space-y-5">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-blue-600 text-white py-2.5 rounded-lg hover:bg-blue-700 flex items-center justify-center gap-2 text-sm"
        >
